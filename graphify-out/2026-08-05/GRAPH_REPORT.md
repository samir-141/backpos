...
Cohesion: 0.12
Nodes (17): eslint-config-prettier, eslint-plugin-prettier, devDependencies, eslint-config-prettier, eslint-plugin-prettier, prettier, @swc/cli, ts-jest (+9 more)
...
Cohesion: 0.22
Nodes (9): bcrypt, @nestjs/passport, @nestjs/platform-express, dependencies, bcrypt, @nestjs/passport, @nestjs/platform-express, @types/pdfmake (+1 more)
